...
var ProposalShowComponent = (function () {
    function ProposalShowComponent(route, http, proposalService) {
        this.route = route;
        this.http = http;
    ...
    ProposalShowComponent.prototype.getProposal = function () {
        var _this = this;
        var proposalRequest = this.route.params
            .flatMap(function (params) { return _this.proposalService.getProposal(+params['id']); });
        proposalRequest.subscribe(function (response) { return _this.proposal = response; }, function (error) { return _this.errorMessage = error; });
    };
